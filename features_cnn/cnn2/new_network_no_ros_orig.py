...
import keras
from keras.layers import Input, merge, Conv2D, MaxPooling2D, UpSampling2D, Lambda, Concatenate	
...
def create_model_lines():
    ...
    model_lines = Model(input=inputs, output=conv10)
...
class image_converter:
  ...
  def cleaner (self,img,thr,size,orig):
