...
if rec == 4:
    ...
    window_init_point_w = np.array([[0, 2, 0], [0, -2, 0]])
    red_search_window_init_point_bound_w = np.array([[2, 2], [2, 2]])
    window_init_size_ratio = np.array([0.07, 0.1])
else:
